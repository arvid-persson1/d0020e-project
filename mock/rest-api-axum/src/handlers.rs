...
pub async fn get_book(State(state): State<Arc<APPState>>, Path(isbn): Path<String>) -> impl IntoResponse{
...
pub async fn add_book(State(state): State<Arc<APPState>>, Xml(new_book): Xml<Book>) -> impl IntoResponse{
